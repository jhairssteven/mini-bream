...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/config' + '/lidar_filtering/self_filter',
            glob('config/lidar_filtering/self_filter/*')),
        ('share/' + package_name + '/config' + '/lidar_filtering/ransac',
            glob('config/lidar_filtering/ransac/*')),
        ('share/' + package_name + '/config' + '/lidar_filtering/pc_clustering',
            glob('config/lidar_filtering/pc_clustering/*')),
    ...
    entry_points={
        'console_scripts': [
            ...
            'pc_clustering = frontseat.lidar_filtering.pc_clustering.PcClusteringNode:main',
        ],
    },
)
