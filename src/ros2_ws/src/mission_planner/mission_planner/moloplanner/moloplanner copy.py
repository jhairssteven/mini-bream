...
class Moloplanner():
    ...
    def bev_pixel_astart_path(self, 
        ...
        path = astart_planner.plan(image_path=None, 
                            ...
                            inflate_radius_pxls=self.astart_planner_args['inflate_radius_pxls'])
        return path, pcd
    ...
    def get_gps_local_astart_path(self, img_id: str, input_img_array: np.ndarray, next_waypoint_gps, camera_frame_origin_gps, boat_heading_deg):
        ...
        Returns:
            gps_local_astart_path: list of GPS coordinates corresponding to the A* path
            pcl_xz_coordinates: list of PCL coordinates corresponding to the A* path (x, z) in meters
            pcd: pointcloud used for path planning
        """
        ...
        return gps_local_astart_path, pcl_xz_coordinates, pcd
