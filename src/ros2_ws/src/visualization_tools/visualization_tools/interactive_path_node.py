...
class InteractivePathNode(Node):
    def __init__(self):
        ...
        default_positions = [
            [[-66.562442779541016,  -154.827213287353516, 0], [0.0, 0.0, -0.9998044967651367, 0.01977263018488884]],
            [[-67.8695669174194336, -154.948404312133789, 0], [0.0, 0.0, -0.8125176429748535, 0.5829366445541382]],
            [[-68.764777421951294,  -154.0025951862335205, 0.0],[0.0, 0.0, -0.8039597868919373, 0.5946836471557617]],
        ]
